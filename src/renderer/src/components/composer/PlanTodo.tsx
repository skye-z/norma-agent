...
export const PlanTodo: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-[620px] mb-1.5">
      <div className="rounded-xl bg-white/[0.04] border border-norma-accent/20 overflow-hidden">
        <div className="flex items-center gap-2 px-3 py-1.5 border-b border-white/[0.04]">
          ...
          <span className="text-[11px] font-medium text-norma-accent/90">
            执行计划
          </span>
          <span className="text-[10px] text-norma-textDim ml-auto">
            {doneCount}/{total}
          </span>
        </div>
