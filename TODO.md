...
- [ ] **v0.4 - 双模态 UI (Command Bar)**
  - [ ] 开发全局唤出命令栏的独立透明窗口。
  - [ ] 注册全局系统快捷键 (如 Cmd+Space 变体) 控制命令栏的显示/隐藏。
  - [ ] 实现命令栏输入内容与后台 Agent 的快捷交互及结果轻量化展示。

- [ ] **v0.5 - 兜底引擎 V1：感知 (Native Sensing)**
...
- [ ] **v1.0 - 自愈机制与打磨 (Self-Healing & Polish)**
